...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        self.parseClassName = @"BookRepository";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    // Configure the cell
    cell.textLabel.text = [object objectForKey:@"bookname"];
    cell.detailTextLabel.text = [NSString stringWithFormat:@"by  %@", [object objectForKey:@"authorname"]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //NSLog(@"Book name is %@", cell.textLabel.text);
...
{
    NSLog(@"Inside popViewControllerAnimated function");
}
