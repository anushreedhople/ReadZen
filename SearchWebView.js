...
function MyApp_HighlightAllStringsForElement(element,keyword) {
    if (element) {
...
function MyApp_HighlightOccurrencesOfAllStrings( keyword) {
    /*Function to highlight multiple strings in the same chapter*/
